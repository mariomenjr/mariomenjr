...
<article class="text-justify">
  ...
  <p class="mb-5">
    ...
    <i>The Project Phoenix</i>, la cuál recomiendo muchísimo; ver documentales, en especial si hablan de
  ...
  <p class="mb-5">
    ...
    <a href="mailto:mariomenjr@gmail.com" class="text-blue-500">aquí</a>.
  </p>
  <p>Happy coding!</p>
</article>
